...
function CreateDistModal(props) {
    ...
    return (
        <Modal className="modal fade" show={addModal} onHide={setAddModal} >
            <div className="" role="document">
                <form onSubmit={e => add(e, { name, distributor_inn: inn, is_active: isActive, deleted: isDeleted })}>
...
export default connect(mapStateToProps)(CreateDistModal);