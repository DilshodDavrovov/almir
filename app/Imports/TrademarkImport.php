...
class TrademarkImport implements ToCollection, WithHeadingRow, WithHeadings, WithChunkReading, SkipsOnError
{
    ...
    public function collection(Collection $rows)
    {
        ...
        foreach ($rows as $index => $row) {
            $res = Trademark::where('name', '=', $row['naimenovanie'])->first();
            if (empty($res)) {
                Trademark::create([
