...
class DFGImport implements ToCollection, WithHeadingRow, WithHeadings, WithChunkReading, SkipsOnError
{
    ...
    public function collection(Collection $rows)
    {
        ...
        foreach ($rows as $index => $row) {
            $res = DrugFarmGroup::where('name', '=', $row['naimenovanie'])->first();
            if (empty($res)) {
                DrugFarmGroup::create([
